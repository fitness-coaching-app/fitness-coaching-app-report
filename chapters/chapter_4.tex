...
\begin{table}
	...
	\begin{tabularx}{\linewidth}{| >{\centering}X| >{\centering}X|X|X|X|X|X|}
		\hline
		\multirow{2}{*}{ท่าทาง} & \multirow{2}{*}{\shortstack{จำนวน                                                                       \\ครั้ง}} & \multicolumn{5}{c|}{\% likelihood (Average)}  
\cline{3-7}
                        &                             & rightElbow & rightHip & rightShoulder & rightKnee & rightIndex  \\ 
\hline
...
\begin{table}
	\centering
	\caption{รายละเอียดความแม่นยำในการตรวจจับของ ML Kit ของท่าทาง ยกแขนขึ้นด้านข้าง (Side Arm Raises) ในส่วนของ Landmarks rightElbow, rightHip, rightShoulder, และ rightWrist}
	\begin{tabularx}{\linewidth}{| >{\centering}X| >{\centering}X|X|X|X|X|}
		\hline
		\multirow{2}{*}{ท่าทาง} & \multirow{2}{*}{\shortstack{จำนวน                                                                       \\ครั้ง}} & \multicolumn{4}{c|}{\% likelihood (Average)}  
\cline{3-6}
...
\begin{table}
	\centering
	\caption{รายละเอียดความแม่นยำในการตรวจจับของ ML Kit ของท่าทาง ยกแขนขึ้นด้านข้าง (Side Arm Raises) ในส่วนของ Landmarks leftElbow, leftHip, leftShoulder, และ leftWrist
	\begin{tabularx}{\linewidth}{| >{\centering}X| >{\centering}X|X|X|X|X|}
		\hline
		\multirow{2}{*}{ท่าทาง} & \multirow{2}{*}{\shortstack{จำนวน                                                                       \\ครั้ง}} & \multicolumn{4}{c|}{\% likelihood (Average)}  
\cline{3-6}
